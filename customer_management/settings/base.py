...
ASGI_APPLICATION = "customer_management.asgi.application"

DATABASES = {
    "default": {
        "ENGINE": "django.db.backends.postgresql",
        "NAME": config("POSTGRES_DB", default="customer_management"),
        "USER": config("POSTGRES_USER", default="customer_management"),
        "PASSWORD": config("POSTGRES_PASSWORD", default="customer_management"),
